...
* default
* public
#### ক্লাস এবং ইন্টারফেস `private` বা `protected` হতে পারে না।
* ক্লাস বা ইন্টারফেসের মেম্বার (ভেরিয়েবল বা মেথড) গুলো যদি প্রাইভেট হয় তাহলে ওই মেম্বার গুলা অন্য কোথাও থেকে এক্সেস পাওয়া যাবে না শুধু মাত্র ক্লাস বা ইন্টারফেসের ভেতরে থেকে এক্সেস পাওয়া যাবে । 
